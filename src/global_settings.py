...
class init:
	...
	exit_on_missing 	= settings_parser.getboolean(common_section,   	'exit_on_missing')
	...
	dataset_dir			= settings_parser.get(bencher_section,   		'dataset_dir')
	...
	compile_cfg_file	= "compile_flags.cfg"
	...
	run_tmpl_dir		= "run"
	compile_tmpl_file	= "compile_flags.template"
