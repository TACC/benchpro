...
def make_mod(general_opts, build_opts, mod_opts, settings, log_to_use):
	...
	mod_path = gs.module_path + gs.sl + mod_dict['system'] + gs.sl + common.get_label(mod_dict['compiler']) + gs.sl + common.get_label(mod_dict['mpi']) + gs.sl + mod_dict['code'] + gs.sl + mod_dict['opt_label']
