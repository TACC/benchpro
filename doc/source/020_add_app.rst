...
This file must be located in :code:`$BP_HOME/config/build`, preferably with the naming scheme :code:`[label].cfg`.
...
It is possible to define your own .lua module template and store it in :code:`$BP_HOME/templates/build` with the naming scheme :code:`[code_label].module`, alternatively BenchPRO will generate a generic module file for you.
